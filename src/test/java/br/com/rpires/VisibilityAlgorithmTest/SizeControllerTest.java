...
import br.com.rpires.VisibilityAlgorithmTest.controller.ProductController;
...
@WebMvcTest(controllers = SizeController.class)
public class SizeControllerTest {
    ...
    public void findAllTest() throws Exception {
        mockMvc.perform(get("/size?page=0&size=1", 0,1)
    ...
    public void whenFileUploaded_thenVerifyStatus()
        ...
        mockMvc.perform(multipart("/size/upload").file(file))
                .andExpect(status().isOk());
    }
